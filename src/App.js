...
export default function PantoneColorMixer() {
  ...
  const [sortBy, setSortBy] = useState("name"); // name, lightness, saturation
  ...
  const downloadFormula = () => {
    ...
    let content = `Pantone Color Formula\n`;
    content += `=====================\n\n`;
    content += `Color: ${selectedColor.name}\n`;
    content += `HEX: ${selectedColor.hex}\n`;
    ...
    content += `Base Required: ${selectedColor.base}\n`;
    ...
    a.href = url;
    a.download = `${selectedColor.name.replace(/\s+/g, "_")}_formula.txt`;
