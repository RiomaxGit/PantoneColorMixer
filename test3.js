...
export default function PantoneColorMixer() {
  ...
  <head>
    <meta charset="UTF-8">
    <title>${project.name} - Paint Project Report</title>
    <style>
      @page {
        size: A4;
        margin: 0;
  ...
  <body>
    <div class="page">
      <div class="header">
        <h1>🎨 Paint Project Report</h1>
        <div class="subtitle">Professional Color Specification Document</div>
      </div>
      ...
      <div class="project-info">
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <span class="info-value">${project.items.length} color${
      project.items.length > 1 ? "s" : ""
          ...
          <div class="info-item">
            ...
            <span class="info-value">Home Depot #7153</span>
          </div>
        </div>
      </div>
      ...
      <div class="color-item">
        <div class="color-header">
          <div class="color-swatch" style="background-color: ${
            ...
            <div style="width: 100%; height: 100%; display: flex; align-items: flex-end; justify-content: flex-end; padding: 4px;">
              <div style="background: rgba(255,255,255,0.9); padding: 2px 6px; border-radius: 3px; font-size: 10px; font-weight: 600; color: #1e293b;">${
                item.color.hex
              }</div>
            </div>
          </div>
          <div class="color-title">
            ...
            <div class="item-number">Item ${idx + 1} of ${
            project.items.length
          }${item.roomName ? ` • ${item.roomName}` : ""}</div>
          </div>
        </div>
        
        <div class="properties-section">
          <div class="section-title">Paint Specifications</div>
          <div class="properties-grid">
            <div class="property">
              <div class="property-label">Quantity</div>
              <div class="property-value">${item.quantity} ${item.unit}</div>
            </div>
            <div class="property">
              <div class="property-label">Finish</div>
              <div class="property-value">${item.shine}</div>
            </div>
            <div class="property">
              <div class="property-label">Base Required</div>
              <div class="property-value">${item.color.base
                .replace(/_/g, " ")
                .toUpperCase()}</div>
            </div>
            ${
              item.area
                ? `
            <div class="property">
              <div class="property-label">Coverage Area</div>
              <div class="property-value">${item.area} sq ft</div>
            </div>
            `
                : ""
            }
            <div class="property">
              ...
              <div class="property-value">${props.hsl.l}%</div>
            </div>
            <div class="property">
              <div class="property-label">Saturation</div>
              <div class="property-value">${props.hsl.s}%</div>
            </div>
          </div>
        </div>
        ...
        <div class="properties-section">
          ...
          <div class="color-values-grid">
            <div class="color-value-box">
              ...
              <div class="property-value" style="font-size: 16px;">${
                item.color.hex
              }</div>
            ...
            <div class="color-value-box">
              <div class="property-label">RGB</div>
              <div class="property-value">${props.rgb.r}, ${props.rgb.g}, ${
            props.rgb.b
          }</div>
              <div style="display: flex; gap: 2px; margin-top: 8px;">
                <div style="flex: 1; height: 8px; background: rgb(${
                  props.rgb.r
                }, 0, 0); border-radius: 2px;"></div>
                <div style="flex: 1; height: 8px; background: rgb(0, ${
                  props.rgb.g
                }, 0); border-radius: 2px;"></div>
                <div style="flex: 1; height: 8px; background: rgb(0, 0, ${
                  props.rgb.b
                }); border-radius: 2px;"></div>
              </div>
            </div>
            <div class="color-value-box">
              <div class="property-label">HSL</div>
              <div class="property-value">${props.hsl.h}°, ${props.hsl.s}%, ${
            props.hsl.l
          }%</div>
            </div>
            <div class="color-value-box">
              <div class="property-label">CMYK</div>
              <div class="property-value">${props.cmyk.c}%, ${props.cmyk.m}%, ${
            props.cmyk.y
          }%, ${props.cmyk.k}%</div>
            </div>
          </div>
        ...
        <div class="colorants-section">
          <div class="colorants-title">⚗️ Colorant Mixing Formula</div>
          <div class="colorants-grid">
            ${Object.entries(colorants)
              .map(
                ([colorant, amount]) => `
              <div class="colorant-item">
                <span class="colorant-code">${colorant}</span>
                <span class="colorant-amount">${amount} ml</span>
              </div>
            `
              )
              .join("")}
          ...
          <div class="warning-box">
            <p><strong>⚠️ Important:</strong> Always shake base thoroughly before adding colorants. Add colorants in the order listed above for best color accuracy. Mix for minimum 5 minutes after all colorants are added.</p>
          </div>
        </div>
      </div>
        `;
      ...
      <div class="footer">
        <p><strong>Created with Pantone Color Mixer</strong></p>
        <p>Built for Home Depot Store #7153 by Akhil Antony Joseph</p>
        <p style="margin-top: 8px; font-size: 11px;">This document contains proprietary color formulation data. Please verify all measurements before mixing.</p>
      </div>
    </div>
  </body>
  </html>
